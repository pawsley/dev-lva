$(document).ready(function () {
  ...
  if ($('.simplebar-wrapper .simplebar-content-wrapper').length > 0 && $('#pageWrapper').hasClass('compact-wrapper')) {
    // Get the element with the class 'active' within the specified container
    var $activeElement = $('.simplebar-wrapper .simplebar-content-wrapper a.active');

    // Check if the active element exists within the container
    if ($activeElement.length > 0) {
        // Animate scrolling to the top of the active element
