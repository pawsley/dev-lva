              ...
              <div class="row">
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active">Printing Material</li>
                    </ol>
                </div>
              </div>
            </div>
                      ...
                      <div class="card-header pb-0 card-no-border d-flex justify-content-between align-items-center">
                          <div class="row">
                            <div class="col-md-12 mb-4">
                                <h4>List Printing Material</h4>
                            </div>
                            <div class="col-md-12">
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#PmbModal">Printing Material Baru</button>
                            </div>
                          </div>
                      </div>
                      <div class="card-body">
                          <div class="table-responsive">
                              <table class="display" id="table-printmaterial">
                                <thead>
                                    <tr>
                                        <th style="min-width: 150px;"> <span class="f-light f-w-600">NAMA PEMOHON</span></th>
                                        <th style="min-width: 150px;"> <span class="f-light f-w-600">TANGGAL & WAKTU</span></th>
                                        <th> <span class="f-light f-w-600">INVOICE</span></th>
                                        <th style="min-width: 100px;"> <span class="f-light f-w-600">ID SUPPLIER</span></th>
                                        <th style="min-width: 200px;"> <span class="f-light f-w-600">NAMA SUPPLIER</span></th>
                                        <th> <span class="f-light f-w-600">JUMLAH</span></th>
