...
class MasterProduk extends Auth
{
  ...
  public function index(){
    $data['content'] = $this->load->view('master/masterproduk', '', true);
    $data['modal'] = '';
...
/* End of file MasterProduk.php */
/* Location: ./application/controllers/MasterProduk.php */